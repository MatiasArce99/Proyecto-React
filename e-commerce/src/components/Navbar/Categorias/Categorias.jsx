    ...
    return (
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
                ...
                <button className='btn btn-secondary'><svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} fill="currentColor" className="bi bi-house-door-fill" viewBox="0 0 16 16">
            ...
            <li className="nav-item">
                ...
                <button className='btn btn-secondary'><svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} fill="currentColor" className="bi bi-pc" viewBox="0 0 16 16">
            ...
            <li className="nav-item">
                ...
                <button className='btn btn-secondary'><svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} fill="currentColor" className="bi bi-xbox" viewBox="0 0 16 16">
            ...
            <li className="nav-item">
                ...
                <button className='btn btn-secondary'><svg xmlns="http://www.w3.org/2000/svg" width={25} height={25} fill="currentColor" className="bi bi-playstation" viewBox="0 0 16 16">
